...
| [004](todo/004-llm-provider-selection.md) | LLM provider selection (Bedrock + SDF-Sage LiteLLM) | 🟡 P2 | ✅ Merged | main | — |
| [005](todo/005-sdf-sage-token-auth.md) | Improved SDF-Sage token auth (OOD-native) | 🔵 P3 | 📋 Preparing | — | — |

**Summary:** 3 merged · 0 in progress · 2 open
...
## Status Key
- 📋 Preparing — task created, codebase-draft not yet run
- ⬜ Open — codebase-draft complete, awaiting /codebase-board-review
